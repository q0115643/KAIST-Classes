...
def read_files(data_loc, vector_size, window, epochs, min_df, max_df):
    """Read the data files.
...
if __name__ == "__main__":
    ...
    min_df = 1
    max_df = 1.0
    acc0 = run(vector_size, window, epochs, min_df, max_df)
    print("=====================")
    print("vector_size: " + str(vector_size) + "   window: " + str(window) + "   epochs: " + str(epochs))
